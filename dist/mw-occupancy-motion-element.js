 ...
 *
 * v2.0 — é a v0.1.0 (a que foi validada na tela) com UMA adição: editor
 * visual (`getConfigElement`), formulário em vez de YAML cru. Nada mais
 * mudou: mesmas medidas, mesmas cores, mesmo desenho.
 *
  ...
  class MwOccupancyMotionElement extends HTMLElement {
    static getStubConfig() {
      return {
        ...
        entity: "", left: "50%", top: "50%", size: "6vh",
      };
    }
...
<div class="box"><ha-icon class="ico"></ha-icon></div>`;
   ...
   * o editor não é caminho obrigatório para nada.
   */
  const LABELS = {
    entity: "Entidade", name: "Nome (tooltip)", left: "Esquerda", top: "Topo",
    size: "Tamanho da caixa", scale: "Escala", rotate: "Rotação",
    ...
    plate_frost: "Vidro fosco (px)", ring: "Borda da placa (px)",
      ...
      type: "expandable", name: "", title: "Cores e ajuste fino", schema: [
        ...
        },
        {
          type: "grid", name: "", schema: [
            ...
            { name: "ring", selector: { number: { min: 0, max: 12, step: 1, mode: "box" } } },
  ...
  class MwOccupancyMotionElementEditor extends HTMLElement {
    ...
    _render() {
      ...
      ["size", "animation", "animation_when", "plate", "elevation", "glow",
        "glow_when", "show_age", "reduced_motion", "lock_when_broken",
